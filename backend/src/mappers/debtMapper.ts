...
export const toGraphQLDebt = (debt: DebtWithCreator) => ({
  ...
  paymentStatus: debt.paymentStatus ?? null,
  paymentReason: debt.paymentReason ?? null,
  paymentRequestedAt: debt.paymentRequestedAt?.toISOString() ?? null,
  paymentRejectedAt: debt.paymentRejectedAt?.toISOString() ?? null,
