...
<template>
  <form class="grid gap-4" @submit.prevent="submit">
    ...
    <label class="grid gap-2">
      <span class="text-sm font-medium text-stone-700">Schuldner</span>
      <InputText v-model="form.debtorName" required />
    </label>

    <label class="grid gap-2">
      <span class="text-sm font-medium text-stone-700">E-Mail des Schuldners</span>
      <InputText v-model="form.debtorEmail" type="email" required />
    </label>

    <label class="grid gap-2">
      <span class="text-sm font-medium text-stone-700">Betrag</span>
      <InputNumber
        v-model="form.amount"
        mode="currency"
        currency="EUR"
    ...
    <label class="grid gap-2">
      <span class="text-sm font-medium text-stone-700">Zweck</span>
    ...
    <label class="grid gap-2">
      <span class="text-sm font-medium text-stone-700">Kategorie</span>
      <AutoComplete
    ...
    <label class="grid gap-2">
      <span class="text-sm font-medium text-stone-700">Datum</span>
