...
<template>
  <div ref="menuRef" class="relative">
    ...
    >
      <form id="password-change-form" class="mt-3 space-y-5" @submit.prevent="submitPasswordChange">
        <FloatLabel :variant="formUi.floatLabelVariant">
          <InputText
            ...
            class="w-full"
          />
          <label for="password-current">Aktuelles Kennwort *</label>
        </FloatLabel>
        <FloatLabel :variant="formUi.floatLabelVariant">
          <InputText
            id="password-new"
            ...
            class="w-full"
          />
          <label for="password-new">Neues Kennwort *</label>
        </FloatLabel>
        <FloatLabel :variant="formUi.floatLabelVariant">
          <InputText
            id="password-confirm"
            ...
            class="w-full"
          />
          <label for="password-confirm">Neues Kennwort wiederholen *</label>
        </FloatLabel>
